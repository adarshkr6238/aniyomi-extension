...
class AnimePahe : ConfigurableAnimeSource, AnimeHttpSource() {
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ...
        val domainPref = EditTextPreference(screen.context).apply {
            ...
            dialogTitle = "Input custom domain (with https://)"
    ...
    companion object {
        ...
        private val PREF_QUALITY_ENTRIES = arrayOf("2160", "1080", "720", "480", "360")

        private const val PREF_DOMAIN_KEY = "preferred_domain"
        private const val PREF_DOMAIN_TITLE = "Custom domain (requires app restart)"
